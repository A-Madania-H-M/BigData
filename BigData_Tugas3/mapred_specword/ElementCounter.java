...
public class ElementCounter {
    public static void main(String[] args) throws Exception {
        if (args.length < 3) {
            System.err.println("Usage: ElementCounter <input_path> <output_path> <element_to_count>");
            System.exit(-1);
        }
